//program that determine and print the score level alongside with the total mark in tabular format.
//Score status : score >=80 Excellent, >=60 Very Good, >= 50 Fair, >=40 poorand <40 Fail.
//By: Zerubbabel
